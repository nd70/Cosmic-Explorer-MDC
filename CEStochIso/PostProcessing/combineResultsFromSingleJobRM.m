function ...
  [sky, numSegments] = ...
    combineResultsFromSingleJobRM(jobCell, ...
...
%
%  $Id: combineResultsFromSingleJobRM.m,v 1.2 2005-09-28 20:38:10 sballmer Exp $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
